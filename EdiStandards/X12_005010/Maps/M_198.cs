	...
	public class L_PWK : MapLoop
	{
		public L_PWK(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new REF() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 5 },
				new L_AIN(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_NX1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_FAA(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_CDA(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
