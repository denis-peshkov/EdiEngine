...
public class M_130 : MapLoop
{
	public M_130() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_SST(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 500 },
			new L_ATV(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 100 },
			new L_TST(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			new L_SUM(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 5 },
	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_HC(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1000 },
				new L_SP(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 30 },
				new L_SES(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1000 },
			});
		}
	}
	...
	public class L_SES : MapLoop
	{
		public L_SES(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new N3() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
				new N4() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
				new L_SUM_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 5 },
				new L_CRS(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 50 },
				new L_DEG(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			});
		}
	}
	...
	public class L_CRS : MapLoop
	{
		public L_CRS(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new N1() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
				new N4() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
				new L_MKS(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			});
		}
	}
