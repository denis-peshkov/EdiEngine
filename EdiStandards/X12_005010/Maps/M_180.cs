...
public class M_180 : MapLoop
{
	public M_180() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_LM(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			new L_BLI(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
		});
	}
	...
	public class L_BLI : MapLoop
	{
		public L_BLI(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_LM_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
				new L_N1_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 200 },
				new L_QTY(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_FA1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new DTM() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 10 },
				new N1() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
				new L_LM_3(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			});
		}
	}
