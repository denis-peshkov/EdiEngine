...
public class M_837 : MapLoop
{
	public M_837() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_NM1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
	...
	public class L_HL : MapLoop
	{
		public L_HL(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_NM1_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
				new L_CLM(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 100 },
			});
		}
	}
