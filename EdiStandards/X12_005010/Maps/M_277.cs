...
public class M_277 : MapLoop
{
	public M_277() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_NM1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
	...
	public class L_HL : MapLoop
	{
		public L_HL(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_TRN(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_TRN : MapLoop
	{
		public L_TRN(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_PWK(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_SVC(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_SVC : MapLoop
	{
		public L_SVC(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_PWK_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
