...
public class M_840 : MapLoop
{
	public M_840() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_N9(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1000 },
			new L_N1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10000 },
			new L_SPI(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
			new L_PCT(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			new L_ADV(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
	...
	public class L_SPI : MapLoop
	{
		public L_SPI(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_CB1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_PO1 : MapLoop
	{
		public L_PO1(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new CTB() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				new MEA() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 40 },
				new L_PID(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1000 },
				new PWK() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 25 },
				new PKG() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 200 },
				...
				new L_LDT(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
	...
	public class L_LDT : MapLoop
	{
		public L_LDT(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_LM(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
			});
		}
	}
