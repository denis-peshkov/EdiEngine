...
public class M_806 : MapLoop
{
	public M_806() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_CAL(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			new L_RSC(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			new L_TID(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
		});
	}
	...
	public class L_TID : MapLoop
	{
		public L_TID(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_MTX(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_RSC_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_MLS(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
