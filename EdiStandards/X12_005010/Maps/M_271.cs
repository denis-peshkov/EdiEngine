	...
	public class L_HL : MapLoop
	{
		public L_HL(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new LUI() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 9 },
				new MPI() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 9 },
				new L_EB(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_EB : MapLoop
	{
		public L_EB(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_III(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new LS() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				new L_NM1_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
