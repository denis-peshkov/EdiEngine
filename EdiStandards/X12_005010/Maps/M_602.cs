...
public class M_602 : MapLoop
{
	public M_602() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_PR(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 100 },
			new L_SB(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 99 },
	...
	public class L_SB : MapLoop
	{
		public L_SB(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_SC(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 400 },
				new L_SRT(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999 },
			});
		}
	}
	...
	public class L_SC : MapLoop
	{
		public L_SC(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_RA(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
				new L_RH(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 20 },
			});
		}
	}
	...
	public class L_SRT : MapLoop
	{
		public L_SRT(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_LX(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 200 },
			});
		}
	}
	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_SRM(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 100 },
			});
		}
	}
