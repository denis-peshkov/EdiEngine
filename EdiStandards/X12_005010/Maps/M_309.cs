	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_M12(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				new L_VID(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999 },
			});
		}
	}
	...
	public class L_VID : MapLoop
	{
		public L_VID(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_N10(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999 },
			});
		}
	}
	...
	public class L_N10 : MapLoop
	{
		public L_N10(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_H1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			});
		}
	}
