...
public class M_219 : MapLoop
{
	public M_219() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_N7(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 99 },
	...
	public class L_S5 : MapLoop
	{
		public L_S5(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_G61(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 99 },
	...
	public class L_G61 : MapLoop
	{
		public L_G61(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_LH1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 25 },
			});
		}
	}
	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L11() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 10 },
				new L_G61_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 99 },
				new L_LAD(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999 },
			});
		}
	}
