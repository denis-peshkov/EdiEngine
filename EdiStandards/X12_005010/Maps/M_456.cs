...
public class M_456 : MapLoop
{
	public M_456() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_IS1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
			new L_ER(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 99 },
		});
	}
	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_S1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 12 },
			});
		}
	}
	...
	public class L_IS1 : MapLoop
	{
		public L_IS1(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new IS2() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 99 },
