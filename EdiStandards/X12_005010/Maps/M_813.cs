...
public class M_813 : MapLoop
{
	public M_813() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_TFS(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 100000 },
		});
	}
	...
	public class L_TFS : MapLoop
	{
		public L_TFS(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_N1_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 5 },
				new L_TIA(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10000 },
				new L_FGS(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 100000 },
			});
		}
	}
	...
	public class L_FGS : MapLoop
	{
		public L_FGS(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new REF() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 10 },
				new DTM() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 10 },
				new L_N1_2(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 5 },
				new L_TIA_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10000 },
			});
		}
	}
