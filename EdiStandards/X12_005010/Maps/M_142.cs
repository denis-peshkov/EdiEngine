...
public class M_142 : MapLoop
{
	public M_142() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_TDS(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
		});
	}
	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_LM(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 3 },
				...
				new L_AMT(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
			});
		}
	}
	...
	public class L_PRR : MapLoop
	{
		public L_PRR(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new PSC() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				new SSS() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				new L_CID(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_CID : MapLoop
	{
		public L_CID(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_MEA(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_REP : MapLoop
	{
		public L_REP(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_LM_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 3 },
				new L_MEA_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_IT1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
