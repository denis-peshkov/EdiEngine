	...
	public class L_LIN : MapLoop
	{
		public L_LIN(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_SLN(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_PRR : MapLoop
	{
		public L_PRR(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_PRT(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				new L_ITA(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
			});
		}
	}
	...
	public class L_SLN : MapLoop
	{
		public L_SLN(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new LOC() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
				new DTM() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 2 },
				new L_N1_2(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				new L_PRR_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_PRR_1 : MapLoop
	{
		public L_PRR_1(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				new PRR() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				new MSG() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				new L_REP_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_PRT_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				new L_ITA_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
			});
		}
	}
