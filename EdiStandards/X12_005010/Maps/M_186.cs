	...
	public class L_BOR : MapLoop
	{
		public L_BOR(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new MSG() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				new L_NM1_2(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_SPK(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_LTR(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_UC(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new LS() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
				new L_UD(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
	...
	public class L_HL : MapLoop
	{
		public L_HL(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_EFI(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_UD : MapLoop
	{
		public L_UD(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_EFI_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
