...
public class M_138 : MapLoop
{
	public M_138() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_DEG(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 5 },
			new L_SST(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			new L_PCL(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 25 },
			new L_ATV(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
		});
	}
	...
	public class L_IN1 : MapLoop
	{
		public L_IN1(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_EMS(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			});
		}
	}
	...
	public class L_SBT : MapLoop
	{
		public L_SBT(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_RAP(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_SCA(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
