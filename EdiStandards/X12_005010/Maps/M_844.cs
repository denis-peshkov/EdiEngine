...
public class M_844 : MapLoop
{
	public M_844() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_N1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 50 },
	...
	public class L_CON : MapLoop
	{
		public L_CON(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_PAD(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1000 },
			});
		}
	}
	...
	public class L_N1_1 : MapLoop
	{
		public L_N1_1(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new REF() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 12 },
				new PER() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 3 },
				new L_SII(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
