...
public class M_470 : MapLoop
{
	public M_470() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_LET(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 150 },
	...
	public class L_LET : MapLoop
	{
		public L_LET(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new MEA() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 4 },
				new L4() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 75 },
