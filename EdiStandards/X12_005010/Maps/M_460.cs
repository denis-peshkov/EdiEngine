...
public class M_460 : MapLoop
{
	public M_460() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_PT(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 50 },
	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_R9(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 2 },
			});
		}
	}
	...
	public class L_R9 : MapLoop
	{
		public L_R9(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_R2B(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 13 },
			});
		}
	}
