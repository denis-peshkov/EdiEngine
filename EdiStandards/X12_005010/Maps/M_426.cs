...
public class M_426 : MapLoop
{
	public M_426() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_BNX(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
		});
	}
	...
	public class L_BNX : MapLoop
	{
		public L_BNX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_S1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 6 },
				new PI() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 12 },
				new L_R2(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 13 },
				...
				new L_T1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 64 },
	...
	public class L_R2 : MapLoop
	{
		public L_R2(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_R2B(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 4 },
			});
		}
	}
