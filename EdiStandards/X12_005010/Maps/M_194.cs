	...
	public class L_HL : MapLoop
	{
		public L_HL(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_N9_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_PO1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_PPL(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
	...
	public class L_N9_1 : MapLoop
	{
		public L_N9_1(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L11() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				new MTX() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				new L_INX(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_PPL : MapLoop
	{
		public L_PPL(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_PD(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_PL(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
	...
	public class L_LX : MapLoop
	{
		public L_LX(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_N9_2(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_DEG(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new L_K2(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
			});
		}
	}
