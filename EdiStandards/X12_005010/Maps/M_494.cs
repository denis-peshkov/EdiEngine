...
public class M_494 : MapLoop
{
	public M_494() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_R9(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			new L_SCL(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999 },
		});
	}
	...
	public class L_R9 : MapLoop
	{
		public L_R9(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new L_R2B(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 10 },
			});
		}
	}
