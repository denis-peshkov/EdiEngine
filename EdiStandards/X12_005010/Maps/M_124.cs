...
public class M_124 : MapLoop
{
	public M_124() : base(null)
	{
		Content.AddRange(new MapBaseEntity[] {
			...
			new L_SUP(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
	...
	public class L_VEH : MapLoop
	{
		public L_VEH(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new VAT() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				...
				new LE() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				new L_LM_1(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
	...
	public class L_N9 : MapLoop
	{
		public L_N9(MapLoop parentLoop) : base(parentLoop)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new DL() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 999999 },
				new MSG() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
			});
		}
	}
